  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="max-w-screen-xl p-8 bg-white rounded-lg shadow-lg">
        ...
        OpenTable faces challenges when seating 30 or more guests simultaneously, making it hard to manage and recall notes and tags efficiently. Transmitting this crucial information to the kitchen and managers becomes nearly impossible in such scenarios.
